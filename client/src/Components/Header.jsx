...
const Header = () => {
    ...
    return (
        <header className="flex justify-between items-center bg-[#6A5F5A] text-white h-[60px]">
            <div className="text-lg font-bold p-[15px]">
                <div className='pl-[15px]'>
                    <a to="/"> {/* Use Link for navigation */}
                        <img
            ...
            <div className="text-sm font-normal pr-[15px]">
                <div className='p-[6px] text-[#ffffffd1]'>
                    {currentTime}
                </div>
            </div>
        </header>
