                    ...
                    <div className="m-3 overflow-auto h-full" style={{ boxShadow: "0 1.6px 3.6px 0 rgba(0,0,0,0.132),0 0.3px 0.9px 0 rgba(0,0,0,0.108)" }}>
                        ...
                        <header className="flex bg-[#908d89] h-[50px] justify-between items-center">
                            <div className="flex text-sm  md:flex-row">
                                <div
                                    className={` cursor-pointer py-[0.6rem] md:py-[14px] h-[50px] md:h-[50px] px-4 md:px-[29px] border-t-2 md:border-t-[3px] ${activeTab === 'newClient' ? 'bg-white border-black text-[#282f3a]' : 'text-white border-[#908d89]'}`}
                                    onClick={() => setActiveTab('newClient')}
                                >
                                    New Client
                                </div>
                                <div
                                    className={`cursor-pointer py-[0.6rem] md:py-[14px] h-[50px] md:h-[50px] px-4 md:px-[18px] border-t-2 md:border-t-[3px] ${activeTab === 'existingClient' ? 'bg-white border-black text-[#282f3a]' : 'text-white border-[#908d89]'}`}
                                    onClick={() => setActiveTab('existingClient')}
                                >
                                    Existing Client
                                </div>
                                <div
                                    className={`cursor-pointer py-[0.6rem] md:py-[14px] h-[50px] md:h-[50px] px-4 md:px-[22px] border-t-2 md:border-t-[3px] ${activeTab === 'newProvider' ? 'bg-white border-black text-[#282f3a]' : 'text-white border-[#908d89]'}`}
