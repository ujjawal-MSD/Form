...
const generateEmailContent = async formData => {
	const sportsCasinoProvidersList = Array.isArray(formData.sportsCasinoProviders)
		? formData.sportsCasinoProviders.map(provider => `<li>${provider}</li>`).join('')
		: '';
	const liveCasinoProvidersList = Array.isArray(formData.liveCasinoProviders)
		? formData.liveCasinoProviders.map(provider => `<li>${provider}</li>`).join('')
		: '';
	const slotGameProvidersList = Array.isArray(formData.slotGameProviders)
		? formData.slotGameProviders.map(provider => `<li>${provider}</li>`).join('')
		: '';
	const fantasyGameProvidersList = Array.isArray(formData.fantasyGameProviders)
		? formData.fantasyGameProviders.map(provider => `<li>${provider}</li>`).join('')
		: '';
		...
		formData.submissionDateTime
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <ul>
                            <li><strong>Required Domain:</strong> ${
		formData.requiredDomain
 }</li>
                            <li><strong>WhatsApp Deposit No.:</strong> ${
		formData.whatsappDepositNo
 }</li>
                            <li><strong>WhatsApp Withdrawal No.:</strong> ${
		formData.whatsappWithdrawalNo
 }</li>
                            <li><strong>Telegram Group Id:</strong> ${
		formData.telegramGroupId
 }</li>
                            <li><strong>Instagram Id:</strong> ${
		formData.instaLink
 }</li>
                            <li><strong>Twitter Id:</strong> ${
		formData.xLink
 }</li>
                            <li><strong>Customer No.:</strong> ${
		formData.customerNo
 }</li>
                        </ul>
                    </div>
